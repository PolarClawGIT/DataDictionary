...
namespace DataDictionary.DataLayer.DatabaseData.Routine
{
        ...
        IKeyEquality<IDbTableColumnKeyName>
    {
        ...
        /// <inheritdoc/>
        public Boolean Equals(DbRoutineDependencyKeyName? other)
        {
            return
        ...
        /// <inheritdoc/>
        public Boolean Equals(IDbRoutineDependencyKeyName? other)
        { return other is IDbRoutineDependencyKeyName value && Equals(new DbRoutineDependencyKeyName(value)); }
        ...
        /// <inheritdoc/>
        public Int32 CompareTo(DbRoutineDependencyKeyName? other)
        {
        ...
        /// <inheritdoc/>
        public Int32 CompareTo(IDbRoutineDependencyKeyName? other)
        { if (other is IDbRoutineDependencyKeyName value) { return CompareTo(new DbRoutineDependencyKeyName(value)); } else { return 1; } }
        ...
        /// <inheritdoc/>
        public static Boolean operator ==(DbRoutineDependencyKeyName left, DbRoutineDependencyKeyName right)
