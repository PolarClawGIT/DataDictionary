...
namespace DataDictionary.DataLayer.AppCatalog
{
        ...
        where TItem : ConstraintColumnItem, IConstraintColumnItem, new()
    {
        ...
        /// <inheritdoc/>
        public Command LoadCommand(IConnection connection, IConstraintKey constraintKey, DateTime asOfUtcDate)
        { return LoadCommand(connection, constraintId: constraintKey.ConstraintId, asOfUtcDate: asOfUtcDate); }
