...
namespace DataDictionary.DataLayer.AppCatalog
{
    ...
    /// </summary>
    public class TableColumnMetaData: BindingTableRow, ITableColumn
    {
        /// <inheritdoc/>
        ...
        /// </summary>
        public TableColumnMetaData() : base() { }
        ...
        public static IEnumerable<ITableColumn> GetSchema(IConnection connection)
        {
            ...
            command.CommandText = SchemaScript.GetInformationSchema(typeof(TableColumn));
