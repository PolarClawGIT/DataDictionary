...
namespace DataDictionary.DataLayer.AppCatalog
{
    ...
    public abstract class SchemaCollection<TItem> : BindingTable<TItem>,
        ...
        IReadTemporal<ICatalogKey>, IReadTemporal<ISchemaKey>, IInfomationSchemaCollection<ISchema>
        where TItem : SchemaItem, ISchemaItem, new()
    {
        ...
        /// <inheritdoc/>
        public Command LoadCommand(IConnection connection, ISchemaKey schemaKey, ITemporalKey asOfUtcDate)
        { return LoadCommand(connection, schemaId: schemaKey.SchemaId, asOfUtcDate: asOfUtcDate.AsOfUtcDate); }
            ...
            DateTime? asOfUtcDate = null, Boolean includeHistory = false)
        {
            ...
            command.AddParameter(Schema.Identifier, schemaId);
