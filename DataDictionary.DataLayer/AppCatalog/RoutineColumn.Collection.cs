...
namespace DataDictionary.DataLayer.AppCatalog
{
    ...
    public abstract class RoutineColumnCollection<TItem> : BindingTable<TItem>,
        ...
        IReadTemporal<ICatalogKey>, IInfomationSchemaCollection<IRoutineColumn>
        where TItem : RoutineColumnItem, IRoutineColumn, new()
    {
        ...
        /// <inheritdoc/>
        public Command LoadCommand(IConnection connection, IRoutineKey routineKey, ITemporalKey asOfUtcDate)
        { return LoadCommand(connection, routineId: routineKey.RoutineId, asOfUtcDate: asOfUtcDate.AsOfUtcDate); }
            ...
            DateTime? asOfUtcDate = null, Boolean includeHistory = false)
        {
            ...
            command.AddParameter(Routine.Identifier, routineId);
        ...
        Command SaveCommand(IConnection connection, Guid? catalogId = null, Guid? routineId = null)
        {
            ...
            command.AddParameter(WriteData.Data, RoutineColumn.TableType, data);
            return command;
        }
        ...
        public virtual void Import(ICatalogKey catalogKey, IEnumerable<IRoutineColumn> columns)
        {
            IEnumerable<RoutineColumnKeyName> allKeys = this.Where(w => catalogKey.Equals(w)).
                ...
                Union(columns.Select(s => new RoutineColumnKeyName(s))).ToList();
