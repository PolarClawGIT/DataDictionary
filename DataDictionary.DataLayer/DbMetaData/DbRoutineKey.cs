    ...
    public class DbRoutineKey : DbSchemaKey, IDbRoutineKey, IEquatable<DbRoutineKey>, IComparable<DbRoutineKey>, IComparable
    {
        ...
        public Boolean Equals(DbRoutineKey? other)
        {
            return (
                ...
                RoutineName.Equals(other.RoutineName, ModelFactory.CompareString));
        }
        ...
        { if (obj is IDbRoutineKey value) { return this.Equals(new DbRoutineKey(value)); } else { return false; } }
