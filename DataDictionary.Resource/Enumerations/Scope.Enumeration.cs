    ...
    IScopeEnumeration
{
    ...
    static ScopeEnumeration()
    {
        List<ScopeEnumeration> data = new List<ScopeEnumeration>()
        {
            ...
            new ScopeEnumeration(ScopeType.DatabaseConstraintKey,      ScopeType.DatabaseConstraint,"Database.Schema.Constraint.Key"),
            new ScopeEnumeration(ScopeType.DatabaseConstraintCheck,    ScopeType.DatabaseConstraint,"Database.Schema.Constraint.Check"),
            ...
            new ScopeEnumeration(ScopeType.ScriptingDocument,          ScopeType.ScriptingData,     "Scripting.Document"),
