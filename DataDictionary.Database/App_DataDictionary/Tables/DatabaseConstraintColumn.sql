...
(
	...
	CONSTRAINT [FK_DatabaseConstraintRefrenceColumn] FOREIGN KEY ([CatalogId], [RefrenceSchemaName], [RefrenceTableName], [RefrenceColumnName]) REFERENCES [App_DataDictionary].[DatabaseTableColumn] ([CatalogId], [SchemaName], [TableName], [ColumnName])
