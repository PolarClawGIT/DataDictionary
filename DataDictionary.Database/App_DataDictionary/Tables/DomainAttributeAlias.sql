...
(
	...
	-- Rethink the aliasing structure, make them "entities" with an "alais name"?
	...
	CONSTRAINT [FK_DomainAttribute] FOREIGN KEY ([DomainAttributeId]) REFERENCES [App_DataDictionary].[DomainAttribute] ([AttributeId])
