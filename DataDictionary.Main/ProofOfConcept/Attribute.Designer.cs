...
namespace DataDictionary.Main.ProofOfConcept.Model
{
    partial class Attribute
    {
        ...
        private void InitializeComponent()
        {
            ...
            dataLengthData = new Controls.TextBoxData();
            dataPrecisionData = new Controls.TextBoxData();
            ...
            dataTypeData = new Controls.ComboBoxData();
            ...
            domainProperty = new Forms.Model.Controls.DomainProperty();
            ...
            domainDefinition = new Forms.Model.Controls.DomainDefinition();
            ...
            aliasNameData = new Controls.TextBoxData();
            aliasScopeData = new Controls.ComboBoxData();
            aliasSelectCommand = new Button();
            aliasAddCommand = new Button();
            isAliasInModelData = new CheckBox();
            subjectAreaTab = new TabPage();
            subjectArea = new Forms.Model.Controls.SubjectArea();
        ...
        private Forms.Model.Controls.DomainProperty domainProperty;
        private BindingSource bindingSubjectArea;
        private Forms.Model.Controls.SubjectArea subjectArea;
        ...
        private Forms.Model.Controls.DomainDefinition domainDefinition;
