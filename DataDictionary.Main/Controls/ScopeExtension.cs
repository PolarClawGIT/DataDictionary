...
namespace DataDictionary.Main.Controls
{
    static class ScopeExtension
    {
        ...
        static Dictionary<ScopeType, ScopeSetting> images = new Dictionary<ScopeType, ScopeSetting>()
        {
            ...
            {ScopeType.ModelDefinition,                  new ScopeSetting(Resources.RichTextBox, Resources.Icon_RichTextBox) },
            {ScopeType.ModelProperty,                    new ScopeSetting(Resources.Property, Resources.Icon_Property) },

            {ScopeType.ModelAttribute,                   new ScopeSetting(Resources.Attribute, Resources.Icon_Attribute) },
            {ScopeType.ModelAttributeAlias,              new ScopeSetting(Resources.Synonym, Resources.Icon_Synonym) },
            {ScopeType.ModelAttributeProperty,           new ScopeSetting(Resources.Property, Resources.Icon_Property) },
            {ScopeType.ModelAttributeDefinition,         new ScopeSetting(Resources.RichTextBox, Resources.Icon_RichTextBox) },

            {ScopeType.ModelEntity,                      new ScopeSetting(Resources.Entity, Resources.Icon_Entities) },
            {ScopeType.ModelEntityAlias,                 new ScopeSetting(Resources.Synonym, Resources.Icon_Synonym) },
            {ScopeType.ModelEntityProperty,              new ScopeSetting(Resources.Property, Resources.Icon_Property) },
            {ScopeType.ModelEntityAttribute,             new ScopeSetting(Resources.Attribute, Resources.Icon_Attribute) },
            {ScopeType.ModelEntityDefinition,            new ScopeSetting(Resources.RichTextBox, Resources.Icon_RichTextBox) },
