...
{ 
    ...
    // I found myself digging thru code to find refrences
    // and trying to be consistant. Using the Enum instead gave
    // me nice context specific code and constsitant behavior.
