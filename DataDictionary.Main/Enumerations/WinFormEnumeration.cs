    ...
    class WinFormEnumeration : Enumeration<ScopeType, WinFormEnumeration>
    {
        ...
        static WinFormEnumeration()
        {
            List<WinFormEnumeration> data = new List<WinFormEnumeration>()
            {
                ...
                new WinFormEnumeration(ScopeType.LibraryTypeParameter,       Resources.Icon_Parameter, Resources.Parameter) { GroupBy = false},
                new WinFormEnumeration(ScopeType.LibraryType,                Resources.Icon_Class, Resources.Class) {GroupBy = false},
                new WinFormEnumeration(ScopeType.Database,                   Resources.Icon_Database,
                    new(ScopeImage.Normal, Resources.Database),
                    new(ScopeImage.New, Resources.NewDatabase),
                    new(ScopeImage.Delete, Resources.DeleteDatabase)) {GroupBy = false} ,
