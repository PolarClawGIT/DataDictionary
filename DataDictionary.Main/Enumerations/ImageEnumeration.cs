        ...
        static ImageEnumeration()
        {
            List<ImageEnumeration> data = new List<ImageEnumeration>()
            {
                ...
                new ImageEnumeration(ScopeType.ApplicationHelp,            Resources.Icon_HelpTableOfContent,
                    ...
                    new(CommandImageType.New, Resources.NewStatusHelp),
                ...
                new ImageEnumeration(ScopeType.Library,                    Resources.Icon_Library,
                    ...
                    new(CommandImageType.New, Resources.NewLibrary),
                ...
                new ImageEnumeration(ScopeType.Database,                   Resources.Icon_Database,
                    ...
                    new(CommandImageType.New, Resources.NewDatabase),
                    new(CommandImageType.Delete, Resources.DeleteDatabase)) {GroupBy = false} ,
                ...
                new ImageEnumeration(ScopeType.DatabaseTable,              Resources.Icon_Table, Resources.Table) ,
                new ImageEnumeration(ScopeType.DatabaseDomain,             Resources.Icon_DomainType, Resources.DomainType) ,
                new ImageEnumeration(ScopeType.DatabaseView,               Resources.Icon_View, Resources.View) ,
                new ImageEnumeration(ScopeType.DatabaseViewColumn,         Resources.Icon_Column, Resources.Column) ,
                new ImageEnumeration(ScopeType.DatabaseTableColumn,        Resources.Icon_Column, Resources.Column) ,
                ...
                new ImageEnumeration(ScopeType.ModelAttribute,             Resources.Icon_Attribute,
                    ...
                    new(CommandImageType.New, Resources.NewAttribute),
                    new(CommandImageType.Delete, Resources.DeleteAttribute)) ,
                new ImageEnumeration(ScopeType.ModelAttributeAlias,        Resources.Icon_Synonym, Resources.Synonym) ,
                ...
                new ImageEnumeration(ScopeType.ModelEntity,                Resources.Icon_Entities, Resources.Entity) ,
                new ImageEnumeration(ScopeType.ModelEntityAlias,           Resources.Icon_Synonym, Resources.Synonym) ,
