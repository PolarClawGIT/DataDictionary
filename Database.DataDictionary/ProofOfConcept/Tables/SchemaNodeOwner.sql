...
(	-- Describes the Owner of a Node within a Schema.
	...
	CONSTRAINT [FK_SchemaNodeOwnerChildNode] FOREIGN KEY ([SchemaId], [NodeId]) REFERENCES [ProofOfConcept].[SchemaNode] ([SchemaId], [NodeId]),
	CONSTRAINT [FK_SchemaNodeOwnerParentNode] FOREIGN KEY ([SchemaId], [NodeOwnerId]) REFERENCES [ProofOfConcept].[SchemaNode] ([SchemaId], [NodeId]),
)
