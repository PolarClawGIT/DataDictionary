CREATE TABLE [ProofOfConcept].[SchemaNodeOwner]
(	-- Describes the Owner of a Node
	...
	CONSTRAINT [FK_SchemaNodeChildNode] FOREIGN KEY ([DefinitionId], [NodeId]) REFERENCES [ProofOfConcept].[SchemaNode] ([DefinitionId], [NodeId]),
	CONSTRAINT [FK_SchemaNodeParentNode] FOREIGN KEY ([DefinitionId], [NodeOwnerId]) REFERENCES [ProofOfConcept].[SchemaNode] ([DefinitionId], [NodeId]),
	CONSTRAINT [FK_SchemaNodeOwnerDefinition] FOREIGN KEY ([DefinitionId]) REFERENCES [ProofOfConcept].[SchemaDefinition] ([DefinitionId]),
