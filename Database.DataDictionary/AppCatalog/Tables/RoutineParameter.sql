...
(
	...
	[ParameterId]            UniqueIdentifier Not Null CONSTRAINT [DF_RoutineParameterId] DEFAULT (newid()),
	...
	-- Keys
	CONSTRAINT [PK_RoutineParameter] PRIMARY KEY CLUSTERED ([ParameterId] ASC),
