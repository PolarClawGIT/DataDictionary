...
(	-- Ties the Template to the Transform and the Data
	...
	CONSTRAINT [AK_TemplateTransformData] UNIQUE ([TemplateId] ASC, [DataId] ASC), -- FK on Data
	CONSTRAINT [FK_TemplateTransformTransform] FOREIGN KEY ([TransformId]) REFERENCES [AppPOC].[Transform] ([TransformId]),
	CONSTRAINT [FK_TemplateTransformTemplate] FOREIGN KEY ([TemplateId]) REFERENCES [AppPOC].[Template] ([TemplateId]),
	CONSTRAINT [FK_TemplateTransformData] FOREIGN KEY ([DataId]) REFERENCES [AppPOC].[DataDefinition] ([DataId]),
)
