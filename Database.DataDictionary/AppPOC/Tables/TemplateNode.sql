CREATE TABLE [AppPOC].[TemplateNode]
(	-- Represents the XSD for the Data
	...
	[NodeOrder]				Int Not Null CONSTRAINT [Df_TemplateDataNodeOrder] DEFAULT (0), -- Render the values elements in this order.
	...
	[SysStart] DATETIME2 (7) GENERATED ALWAYS AS ROW START HIDDEN NOT NULL CONSTRAINT [DF_TemplateDataNode_SysStart] DEFAULT (sysdatetime()),
	[SysEnd] DATETIME2 (7) GENERATED ALWAYS AS ROW END HIDDEN NOT NULL CONSTRAINT [DF_TemplateDataNode_SysEnd] DEFAULT ('9999-12-31 23:59:59.9999999'),
   	PERIOD FOR SYSTEM_TIME ([SysStart], [SysEnd]),
	-- Keys
	CONSTRAINT [PK_TemplateDataNode] PRIMARY KEY CLUSTERED ([NodeId] ASC),
	CONSTRAINT [AK_TemplateDataNode] UNIQUE ([DataId] ASC, [NodeId] ASC), -- Used for FK refrence to insure everything belong TemplateData
	CONSTRAINT [FK_TemplateDataNodeData] FOREIGN KEY ([DataId]) REFERENCES [AppPOC].[TemplateData] ([DataId]),
