...
(
	...
	[ModfiedBy] SysName Not Null CONSTRAINT [DF_ModelScripting_ModfiedBy] DEFAULT (original_login()),
	...
	-- Keys
	CONSTRAINT [PK_ModelScripting] PRIMARY KEY CLUSTERED ([ModelId] ASC, [SelectionId] ASC),
