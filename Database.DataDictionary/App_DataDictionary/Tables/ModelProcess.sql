...
(
	...
	-- Keys
	CONSTRAINT [PK_ModelProcess] UNIQUE CLUSTERED ([ModelId] ASC, [ProcessId] ASC, [SubjectAreaId] ASC),
	...
	CONSTRAINT [FK_ModelProcessSubjectArea] FOREIGN KEY ([ModelId], [SubjectAreaId]) REFERENCES [App_DataDictionary].[ModelSubjectArea] ([ModelId], [SubjectAreaId]),
)
GO
