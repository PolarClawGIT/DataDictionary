CREATE PROCEDURE [App_DataDictionary].[procSetDomainEntitySubjectArea]
		@ModelId UniqueIdentifier = Null,
		@EntityId UniqueIdentifier = Null,
		@Data [App_DataDictionary].[typeDomainEntitySubjectArea] ReadOnly
As
...
Begin Try
	...
	Update	[App_DataDictionary].[ModelSubjectEntity]
	...
	Insert Into [App_DataDictionary].[ModelSubjectEntity] ([ModelId], [EntityId], [SubjectAreaId], [NameSpaceId])
