...
/* Description: Performs Set on Security Role.
*/
...
Begin Try
	...
	Delete From [AppSecurity].[Role]
	From	[AppSecurity].[Role] T
			Left Join @Values S
			On	T.[RoleId] = S.[RoleId]
	Where	S.[RoleId] is Null And
			(@RoleId is Null or @RoleId = T.[RoleId])
