...
(
	...
	-- Keys
	CONSTRAINT [PK_ObjectOwner] PRIMARY KEY CLUSTERED ([PrincipalId] ASC, [ObjectId] ASC),
	CONSTRAINT [FK_ObjectOwner_SecurityPrincipal] FOREIGN KEY ([PrincipalId]) REFERENCES [AppSecurity].[Principal] ([PrincipalId]),
)
