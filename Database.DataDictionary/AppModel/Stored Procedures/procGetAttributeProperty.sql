CREATE PROCEDURE [AppModel].[procGetAttributeProperty]
...
/* Description: Performs Get on Model AttributeProperty.
*/
...
Select	D.[AttributeId],
		...
		[IsDeleted],
		[IsCurrent]
From	[AppModel].[AttributePropertyHs] For System_Time All D
