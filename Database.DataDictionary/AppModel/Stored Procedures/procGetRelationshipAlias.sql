CREATE PROCEDURE [AppModel].[procGetRelationshipAlias]
...
/* Description: Performs Get on DomainRelationshipAlias.
*/
...
Select	D.[RelationshipId],
		...
		[IsDeleted],
		[IsCurrent]
From	[AppModel].[RelationshipAliasHs] For System_Time All D
