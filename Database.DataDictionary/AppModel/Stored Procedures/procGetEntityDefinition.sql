CREATE PROCEDURE [AppModel].[procGetEntityDefinition]
...
/* Description: Performs Get on Model EntityDefinition.
*/
...
Select	D.[EntityId],
		...
		[IsDeleted],
		[IsCurrent]
From	[AppModel].[EntityDefinitionHs] For System_Time All D
