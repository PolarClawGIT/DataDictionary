CREATE PROCEDURE [AppModel].[procGetRelationshipDefinition]
...
/* Description: Performs Get on Model RelationshipDefinition.
*/
...
Select	D.[RelationshipId],
		...
		[IsDeleted],
		[IsCurrent]
From	[AppModel].[RelationshipDefinitionHs] For System_Time All D
