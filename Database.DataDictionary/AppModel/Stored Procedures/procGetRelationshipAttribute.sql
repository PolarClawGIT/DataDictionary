CREATE PROCEDURE [AppModel].[procGetRelationshipAttribute]
...
/* Description: Performs Get on Model RelationshipAttribute.
*/
...
Select	[RelationshipId],
		...
		[IsDeleted],
		[IsCurrent]
From	[AppModel].[RelationshipAttributeHs] For System_Time All D
