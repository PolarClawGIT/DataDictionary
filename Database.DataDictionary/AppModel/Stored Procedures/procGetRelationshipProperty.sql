CREATE PROCEDURE [AppModel].[procGetRelationshipProperty]
...
/* Description: Performs Get on Model RelationshipProperty.
*/
...
Select	D.[RelationshipId],
		...
		[IsDeleted],
		[IsCurrent]
From	[AppModel].[RelationshipPropertyHs] For System_Time All D
