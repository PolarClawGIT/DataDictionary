CREATE PROCEDURE [AppModel].[procGetProcessSubjectArea]
...
/* Description: Performs Get on Model ProcessSubjectArea.
*/
...
Select	D.[ProcessId],
		...
		[IsDeleted],
		[IsCurrent]
From	[AppModel].[ProcessSubjectAreaHs] For System_Time All D
