CREATE PROCEDURE [AppScript].[procSetDataSource]
		@ModelId UniqueIdentifier = Null,
		@DataSourceId UniqueIdentifier = Null,
		@Data [AppScript].[udttDataSource] ReadOnly
As
...
Begin Try
	...
	-- Apply Changes
	Insert Into [AppScript].[ScriptingModel] ([ModelId], [TemplateId])
	Select	T.[ModelId],
			T.[TemplateId]
	...
	Insert Into [AppScript].[DataSource] (
			[DataSourceId],
			[DataSourceTitle],
			[DataSourceDescription])
	...
	From	@Values S
			Left Join [AppScript].[DataSource] T
