CREATE TABLE [AppScript].[ScriptingNode]
(
	...
	CONSTRAINT [FK_ScriptingNodeTemplate] FOREIGN KEY ([TemplateId]) REFERENCES [AppScript].[ScriptingTemplate] ([TemplateId]),
...
CREATE UNIQUE INDEX [UK_ScriptingNode_Column]
    ON [AppScript].[ScriptingNode] ([TemplateId] ASC, [PropertyScope] ASC, [PropertyName] ASC);
GO
