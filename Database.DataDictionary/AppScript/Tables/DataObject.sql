...
(
	...
	[DataNameId]		UniqueIdentifier Not Null,
	...
	CONSTRAINT [FK_DataObjectName] FOREIGN KEY ([DataSourceId], [DataNameId]) REFERENCES [AppScript].[DataObjectName] ([DataSourceId], [DataNameId]),
)
