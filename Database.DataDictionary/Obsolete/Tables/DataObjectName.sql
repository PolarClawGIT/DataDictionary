CREATE TABLE [Obsolete].[DataObjectName]
(
	...
	CONSTRAINT [FK_DataNameSource] FOREIGN KEY ([DataSourceId]) REFERENCES [Obsolete].[DataSource] ([DataSourceId]),
	CONSTRAINT [FK_DataNameParent] FOREIGN KEY ([DataSourceId], [ParentNameId]) REFERENCES [Obsolete].[DataObjectName] ([DataSourceId], [ObjectNameId]),
