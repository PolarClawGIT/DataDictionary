CREATE TABLE [Obsolete].[DataObject]
(
	...
	CONSTRAINT [FK_DataObjectSource] FOREIGN KEY ([DataSourceId]) REFERENCES [Obsolete].[DataSource] ([DataSourceId]),
	CONSTRAINT [FK_DataObjectName] FOREIGN KEY ([DataSourceId], [ObjectNameId]) REFERENCES [Obsolete].[DataObjectName] ([DataSourceId], [ObjectNameId]),
