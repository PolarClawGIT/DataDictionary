CREATE PROCEDURE [Obsolete].[procSetDataObject]
		@ModelId UniqueIdentifier = Null,
		@DataSourceId UniqueIdentifier = Null,
		@Data [Obsolete].[udttDataObject] ReadOnly
As
...
Begin Try
	...
	Declare @ObjectName [Obsolete].[udttDataObjectName]
	...
	Exec [Obsolete].[procSetDataObjectName] @ModelId = @ModelId, @DataSourceId = @DataSourceId, @Data = @ObjectName
	...
	Select	X.[DataObjectId],
			...
			D.[ObjectScope]
	From	@Data D
			Cross Apply (Select [Obsolete].[funcObjectNameId]([ObjectPath]) As [ObjectNameId]) N
			Left Join [Obsolete].[DataObject] O
	...
	;With [Data] As (
		Select	D.[DataSourceId],
				...
				N.[ParentNameId]
		From	@Values D
				Inner Join [Obsolete].[DataObjectName] N
	...
	Insert Into [Obsolete].[DataObject] (
			[DataObjectId],
			[DataSourceId],
			[ObjectNameId],
			[ObjectScope])
	Select	S.[DataObjectId],
			...
			S.[ObjectScope]
	From	@Values S
			Left Join [Obsolete].[DataObject] T
