CREATE PROCEDURE [Obsolete].[procSetDocument]
		@ModelId UniqueIdentifier = Null,
		@DocumentId UniqueIdentifier = Null,
		@Data [Obsolete].[udttDocument] ReadOnly
As
...
Begin Try
	...
	-- Apply Changes
	Delete From [Obsolete].[DocumentFile]
	From	[Obsolete].[DocumentFile] T
			Left Join @Files S
	...
	;With [Delta] As (
		...
		Select	[DocumentId],
				...
				[IsProcess],
				[IsOutput]
		From	[Obsolete].[DocumentFile])
	Update [Obsolete].[DocumentFile]
	...
	Insert Into [Obsolete].[DocumentFile] (
			[DocumentId],
			[RelativePath],
			[FileName],
			[IsInput],
	...
	Select	S.[DocumentId],
			...
			S.[IsOutput]
	From	@Files S
			Left Join [Obsolete].[DocumentFile] T
