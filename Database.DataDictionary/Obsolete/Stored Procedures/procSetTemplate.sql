CREATE PROCEDURE [Obsolete].[procSetTemplate]
		@ModelId UniqueIdentifier = Null,
		@TemplateId UniqueIdentifier = Null,
		@Data [Obsolete].[udttTemplate] ReadOnly
As
...
Begin Try
	...
	-- Apply Changes
	Delete From [Obsolete].[TemplateFile]
	From	[Obsolete].[TemplateFile] T
			Left Join @Files S
	...
	Insert Into [Obsolete].[TemplateFile] (
			[TemplateId],
			[RelativePath],
			[FileObject],
			[FilePrefix],
