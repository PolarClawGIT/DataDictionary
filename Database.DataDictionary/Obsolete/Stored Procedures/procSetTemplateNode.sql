CREATE PROCEDURE [Obsolete].[procSetTemplateNode]
		@ModelId UniqueIdentifier = Null,
		@TemplateId UniqueIdentifier = Null,
		@Data [Obsolete].[udttTemplateNode] ReadOnly
AS
...
;	With [Delete] As (
		Select	P.[NodeId],
				P.[NodeOwnerId],
				P.[TemplateId]
		From	[Obsolete].[TemplateNode] T
				Inner Join [Obsolete].[TemplateNodeOwner] P
	...
	Delete From [Obsolete].[TemplateNode]
	From	[Obsolete].[TemplateNode] T
			Left Join @Values S
	...
	;With [Delta] As (
		...
		Select	[NodeId],
				...
				[ObjectProperty],
				[ModelPropertyId]
		From	[Obsolete].[TemplateNode])
	Update	[Obsolete].[TemplateNode]
	...
	Insert Into [Obsolete].[TemplateNode] (
			[NodeId],
			[TemplateId],
			[NodeName],
			[NodeOrder],
	...
	Select	S.[NodeId],
			...
			S.[ModelPropertyId]
	From	@Values S
			Left Join [Obsolete].[TemplateNode] T
