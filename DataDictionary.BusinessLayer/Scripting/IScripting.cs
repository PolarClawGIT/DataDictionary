...
namespace DataDictionary.BusinessLayer.Scripting
{
    ...
    public interface IScripting
    {
        ...
        /// <returns></returns>
        XElement? GetXElement(IBusinessLayerData data, IEnumerable<DefinitionElementValue>? options);
    }
    ...
    {   // This allows the UI layer to reference the generic IBusinessLayerData
        ...
        XElement? IScripting.GetXElement(IBusinessLayerData data, IEnumerable<DefinitionElementValue>? options)
        ...
        XElement? GetXElement(TSource data, IEnumerable<DefinitionElementValue>? options);
    }
}
