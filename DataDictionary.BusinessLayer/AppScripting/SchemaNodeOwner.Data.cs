...
{
    /// <summary>
    /// Interface component for the Scripting SchemaNodeOwner
    /// </summary>
    public interface ISchemaNodeOwnerData :
        IBindingData<SchemaNodeOwnerValue>,
    ...
    class SchemaNodeOwnerData : SchemaNodeOwnerCollection<SchemaNodeOwnerValue>, ISchemaNodeOwnerData
    {
        /// <inheritdoc/>
        ...
        {
            List<WorkItem> work = new List<WorkItem>();
            work.Add(new WorkItem() { WorkName = "Remove Scripting SchemaNodeOwner", DoWork = () => { Remove(dataKey); } });
            return work;
        }
        ...
        {
            List<WorkItem> work = new List<WorkItem>();
            work.Add(new WorkItem() { WorkName = "Remove Scripting SchemaNodeOwner", DoWork = () => { Clear(); } });
            return work;
        }
