...
namespace DataDictionary.BusinessLayer.AppScripting
{
    ...
    /// </summary>
    public class XmlBuilderBase_V2
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="XmlBuilderBase_V2"/> class with a specified node name and rendering behavior.
        /// </summary>
        /// <param name="nodeName">The name of the node.</param>
        /// <param name="renderAs">The rendering behavior for the node.</param>
        public XmlBuilderBase_V2(
            ScopeType nodeName,
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="XmlBuilderBase_V2"/> class with a specified node name, value, and rendering behavior.
        /// </summary>
        /// <param name="nodeName">The name of the node.</param>
    ...
    /// </summary>
    /// <remarks>
    /// This class extends <see cref="XmlBuilderBase_V2"/> and provides functionality to manage child elements
    /// and build a complete <see cref="XElement"/> structure.
    /// </remarks>
    public class XElementBuilder_V2 : XmlBuilderBase_V2
    {
        /// <summary>
        /// Gets the list of child <see cref="XElementBuilder_V2"/> objects.
        /// </summary>
        public List<XElementBuilder_V2> Children { get; } = new();

        /// <summary>
        /// Initializes a new instance of the <see cref="XElementBuilder_V2"/> class with a specified node name.
        /// </summary>
        /// <param name="nodeName">The name of the node.</param>
        public XElementBuilder_V2(
            ScopeType nodeName)
            : base(nodeName)
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="XElementBuilder_V2"/> class with a specified node name, value, and rendering behavior.
        /// </summary>
        /// <param name="nodeName">The name of the node.</param>
        /// <param name="nodeValue">The value of the node.</param>
        /// <param name="renderAs">The rendering behavior for the node.</param>
        ...
        /// <summary>
        /// Creates a collection of <see cref="XElementBuilder_V2"/> objects from the properties of the specified object.
        /// </summary>
        /// <param name="value">The object whose properties will be used to create the builders.</param>
        /// <returns>A collection of <see cref="XElementBuilder_V2"/> objects.</returns>
        public static IEnumerable<XElementBuilder_V2> Create(Object value)
        {
            ...
            foreach (PropertyInfo property in value.GetType().GetProperties().ToList())
            {
                ...
                { result.Add(new XElementBuilder_V2(property.Name, property.GetValue(value))); }
            }
        ...
        private XObject? BuildXObject(XElementBuilder_V2 setting)
        {
            ...
            foreach (XElementBuilder_V2 item in setting.Children)
            {
    ...
    /// <summary>
    /// Provides extension methods for working with a list of <see cref="XElementBuilder_V2"/> objects.
    /// </summary>
    public static class XElementExtension
    {
        /// <summary>
        /// Adds a new <see cref="XElementBuilder_V2"/> to the list with the specified node name, value, and rendering behavior.
        /// </summary>
        /// <param name="values">The list of <see cref="XElementBuilder_V2"/> objects.</param>
        ...
        public static void Add(this IList<XElementBuilder_V2> values, String nodeName, Object? nodeValue = null, TemplateNodeValueAsType renderAs = TemplateNodeValueAsType.ElementText)
        { values.Add(new XElementBuilder_V2(nodeName, nodeValue, renderAs)); }

        /// <summary>
        /// Removes all <see cref="XElementBuilder_V2"/> objects with the specified node name from the list.
        /// </summary>
        /// <param name="values">The list of <see cref="XElementBuilder_V2"/> objects.</param>
        /// <param name="nodeName">The name of the node to remove.</param>
        public static void Remove(this IList<XElementBuilder_V2> values, String nodeName)
        {
            while (values.FirstOrDefault(w => nodeName.Equals(w.GetNodeName())) is XElementBuilder_V2 child)
            { values.Remove(child); }
        }

        /// <summary>
        /// Attempts to retrieve a <see cref="XmlBuilderBase_V2"/> object with the specified node name from the list.
        /// </summary>
        /// <param name="values">The list of <see cref="XElementBuilder_V2"/> objects.</param>
        /// <param name="nodeName">The name of the node to retrieve.</param>
        /// <param name="result">When this method returns, contains the <see cref="XmlBuilderBase_V2"/> object if found; otherwise, <c>null</c>.</param>
        /// <returns><c>true</c> if a node with the specified name was found; otherwise, <c>false</c>.</returns>
        public static Boolean TryGet(this IList<XElementBuilder_V2> values, String nodeName, [NotNullWhen(true)] out XmlBuilderBase_V2? result)
        {
            if (values.FirstOrDefault(w => nodeName.Equals(w.GetNodeName())) is XmlBuilderBase_V2 value)
            { result = value; return true; }
            else { result = null; return false; }
        }

        /// <summary>
        /// Retrieves a <see cref="XmlBuilderBase_V2"/> object with the specified node name from the list.
        /// </summary>
        /// <param name="values">The list of <see cref="XElementBuilder_V2"/> objects.</param>
        /// <param name="nodeName">The name of the node to retrieve.</param>
        /// <returns>The <see cref="XmlBuilderBase_V2"/> object with the specified name.</returns>
        /// <exception cref="IndexOutOfRangeException">Thrown if no node with the specified name is found.</exception>
        public static XmlBuilderBase_V2 Get(this IList<XElementBuilder_V2> values, String nodeName)
        {
            if (values.FirstOrDefault(w => nodeName.Equals(w.GetNodeName())) is XmlBuilderBase_V2 value)
            { return value; }
            else
