...
namespace DataDictionary.BusinessLayer.AppScripting
{
    ...
    class TemplateObjectData : TemplateObjectCollection<TemplateObjectValue>, ITemplateObjectData
    {
        ...
        {
            List<WorkItem> work = new List<WorkItem>();
            work.Add(new WorkItem() { WorkName = "Remove Scripting TemplateObject", DoWork = () => { Remove(dataKey); } });
            return work;
        }
        ...
        {
            List<WorkItem> work = new List<WorkItem>();
            work.Add(new WorkItem() { WorkName = "Remove Scripting TemplateObject", DoWork = () => { Clear(); } });
            return work;
        }
