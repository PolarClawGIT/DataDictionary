...
{
    /// <summary>
    /// Interface component for the Model Process Definition
    /// </summary>
    public interface IProcessDefinitionData : IBindingData<ProcessDefinitionValue>
    { }

    class ProcessDefinitionData : ProcessDefinitionCollection<ProcessDefinitionValue>, IProcessDefinitionData,
        ...
        ILoadData<IModelIndex>, ISaveData<IModelIndex>
    {
        ...
        { return new WorkItem() { WorkName = "Remove ProcessDefinition", DoWork = () => { Clear(); } }.ToList(); }

        /// <inheritdoc/>
        /// <remarks>ProcessDefinition</remarks>
        public IReadOnlyList<WorkItem> Delete(IProcessIndex dataKey)
        { return new WorkItem() { WorkName = "Remove ProcessDefinition", DoWork = () => { Remove(dataKey); } }.ToList(); }
