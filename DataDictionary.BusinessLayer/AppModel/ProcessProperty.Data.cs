...
{
    /// <summary>
    /// Interface component for the Model Process Property
    /// </summary>
    public interface IProcessPropertyData :
        IBindingData<ProcessPropertyValue>
    { }

    class ProcessPropertyData : ProcessPropertyCollection<ProcessPropertyValue>, IProcessPropertyData,
        ILoadData<IProcessIndex>, ISaveData<IProcessIndex>,
        ILoadData<IModelIndex>, ISaveData<IModelIndex>
    {
        /// <inheritdoc/>
        /// <remarks>ProcessProperty</remarks>
        ...
        { return new WorkItem() { WorkName = "Remove ProcessProperty", DoWork = () => { Clear(); } }.ToList(); }

        /// <inheritdoc/>
        /// <remarks>ProcessProperty</remarks>
        public IReadOnlyList<WorkItem> Delete(IProcessIndex dataKey)
        { return new WorkItem() { WorkName = "Remove ProcessProperty", DoWork = () => { Remove(dataKey); } }.ToList(); }
