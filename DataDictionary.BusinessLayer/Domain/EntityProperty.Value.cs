    ...
    public class EntityPropertyValue : DomainEntityPropertyItem, IEntityPropertyValue
    {
        ...
        internal static IReadOnlyList<ColumnItem> GetXColumns()
        {
            ...
            List<ColumnItem> result = new List<ColumnItem>()
            {
                ...
                new ColumnItem() {ColumnName = nameof(EntityNames.PropertyValue),   DataType = typeof(String), AllowDBNull = true,  Scope = scope},
                new ColumnItem() {ColumnName = nameof(EntityNames.DefinitionText),  DataType = typeof(String), AllowDBNull = true,  Scope = scope},
            };
