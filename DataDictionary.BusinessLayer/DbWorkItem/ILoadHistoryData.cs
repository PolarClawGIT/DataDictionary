...
namespace DataDictionary.BusinessLayer.DbWorkItem
{
    ...
    public interface ILoadHistoryData
    {
        ...
        /// <returns></returns>
        public IReadOnlyList<WorkItem> LoadHistory(IDatabaseWork factory, List<ITemporal> target);
        ...
        where TKey : IKey
    {
        ...
        /// <param name="target"></param>
        /// <returns></returns>
        IReadOnlyList<WorkItem> LoadHistory(IDatabaseWork factory, TKey key, List<ITemporal> target);
    }
}
