...
namespace DataDictionary.BusinessLayer.AppSecurity
{
    ...
    /// </summary>
    public interface ISecurableValue : IDataValue, ISecurableAuthorization, IObjectAccess
    { }

    /// <summary>
    /// Implementation for an Item can be cast as a Object Security Value
    /// </summary>
    class SecurableValue : DataValue, ISecurableValue
    {
        /// <inheritdoc/>
        ...
        public SecurableValue(IBindingPropertyChanged source) : base(source)
        { }

        public static SecurableValue Create<TSource>(DataValue baseValue, TSource source)
            where TSource : IBindingPropertyChanged, ISecurableValue
        {
            return new SecurableValue(source)
            {
